var siteConfigJson = {
    ...
    navItems: [
      {
        label: 'Writer',
        subNavItems: [
          { label: 'Interactive', subNavItems: [] },
          { label: 'Fictional', subNavItems: [] },
          { label: 'Journalism', subNavItems: [] }
        ]
      },
      {
        label: 'Developer',
  ...
  content: {
    items: [
      ...
      {
        itemRel: 'writer:fictional',
        label: 'amazingContent',
        paragraphs: [
